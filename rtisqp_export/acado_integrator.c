...
a[4] = (cos(xd[2]));
a[5] = (sin(xd[2]));
a[6] = (atan((((real_t)(2.1880000000000002e+00)*xd[3])-xd[5])));
...
out[3] = ((real_t)(1.2257906349595488e-04)*(((real_t)(1.2050000000000001e+00)*u[0])-((real_t)(2.1880000000000002e+00)*a[7])));
out[4] = ((real_t)(1.1976047904191617e-04)*(u[1]+u[2]));
out[5] = (((real_t)(1.1976047904191617e-04)*(u[0]+a[7]))-(xd[4]*xd[3]));
out[6] = u[3];
}
...
a[15] = (cos(xd[2]));
a[16] = ((real_t)(1.0000000000000000e+00)/((real_t)(1.0000000000000000e+00)+(pow((((real_t)(2.1880000000000002e+00)*xd[3])-xd[5]),2))));
a[17] = ((real_t)(2.1880000000000002e+00)*a[16]);
a[18] = ((real_t)(1.0000000000000000e+00)/xd[4]);
a[19] = ((((real_t)(2.0000000000000000e+00)*od[1])*a[17])*a[18]);
a[20] = (atan((((real_t)(2.1880000000000002e+00)*xd[3])-xd[5])));
a[21] = (a[18]*a[18]);
...
a[25] = ((real_t)(2.1880000000000002e+00)*a[16]);
...
out[36] = ((real_t)(1.2257906349595488e-04)*((real_t)(0.0000000000000000e+00)-((real_t)(2.1880000000000002e+00)*a[19])));
out[37] = ((real_t)(1.2257906349595488e-04)*((real_t)(0.0000000000000000e+00)-((real_t)(2.1880000000000002e+00)*a[22])));
out[38] = ((real_t)(1.2257906349595488e-04)*((real_t)(0.0000000000000000e+00)-((real_t)(2.1880000000000002e+00)*a[24])));
...
out[58] = (((real_t)(1.1976047904191617e-04)*a[26])-xd[4]);
out[59] = (((real_t)(1.1976047904191617e-04)*a[27])-xd[3]);
out[60] = ((real_t)(1.1976047904191617e-04)*a[29]);
